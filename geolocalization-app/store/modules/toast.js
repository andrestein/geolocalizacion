/**
 * Control de los toast para mostrar mensajes en el aplicativo
 */
    ...
    if (error.response) {
      ...
      if (!data.success) {
        ...
        if (info && info.detail && info.detail.includes("already exists")) {
          state.toastMessage = "Válida los campos, ya hay un registro existente";
          state.toast = true;
        } else {
